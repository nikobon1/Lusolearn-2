                    ...
                    <div>
                        ...
                        <div className="mb-4 p-3 rounded-lg bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800">
                            <p className="text-sm text-violet-700 dark:text-violet-300">
                                <span className="font-medium">📁 Папка:</span>{' '}
                                <strong>
                                    {suggestedNewFolder
                                        ? suggestedNewFolder.name + ' (создастся автоматически)'
                                        : (selectedFolderId === 'default' ? 'Без категории' : folders.find(f => f.id === selectedFolderId)?.name)
                                    }
                                </strong>
                            </p>
                        </div>
